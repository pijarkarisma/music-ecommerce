<div class="grid grid-cols-1 p-6 lg:grid-cols-2 lg:p-0 bg-zinc-900 h-screen overflow-scroll">
    ...
    <div class="flex justify-center items-center flex-col">
        ...
        <div class="grid gap-y-6">
            ...
            <a type="button" class="flex h-14 w-56 lg:w-64 text-center bg-music-stone items-center justify-center rounded-[60px]">
