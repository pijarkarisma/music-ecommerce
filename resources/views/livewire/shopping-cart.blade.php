            ...
            <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                ...
                <div class="overflow-hidden justify-center flex">
                    ...
                    <thead class="border-b bg-music-red">
                        <tr>
                        <th scope="col" class="text-sm font-medium text-white px-6 py-4 rounded-tl-lg">
                        ...
                        <th scope="col" class="text-sm font-medium text-white px-6 py-4 rounded-tr-lg">
                            Subtotal
                        </th>
                        </tr>
                        ...
                        <tbody>
                            ...
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-normal">
                                <div class="flex flex-row items-center gap-x-6">
                                    <img src="/images/piano/yamaha_piano.jpg" alt="" class="h-[142px] w-[142px]">
