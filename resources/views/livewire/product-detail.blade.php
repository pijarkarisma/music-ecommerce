            ...
            <div class="flex flex-row">
                ...
                <div class="flex flex-col ml-8 gap-y-6">
                    ...
                    <div class="flex flex-row gap-x-2">
                        ...
                        <p class="text-xl text-green-500">In stock - {{ $product->inventory->quantity }} units</p>
                        @else
                    ...
                    <div class="flex flex-row items-center gap-x-10">
                        <div class="flex flex-row gap-x-4 text-xl text-white items-center content-center font-semibold mt-8">
                            ...
                            <button type="button" wire:click.prevent="addToCart" class="flex h-14 w-56 lg:w-64 text-center bg-music-red items-center justify-center rounded-[60px] ml-4">
                                <p class="text-xl text-white font-normal">Add to cart</p>
                            </button>  
                            <p class="text-4xl font-semibold text-white ml-8">@convert($total)</p>
                        </div>        
                    </div>
                </div>
            </div>
